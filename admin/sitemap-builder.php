...
<div class="container">
    <div class="row">
        ...
        <div class="text-center">
            <div class="foot-icon-grid">
                <a href="https://twitter.com/YachtsDotCom" target="_blank" class="social-icon" style="background-color:#1DA1F2">
            ...
            <div class="foot-icon-grid">
                <a href="https://www.pinterest.com/yachtsdotcom/" target="_blank" class="social-icon" style="background-color:#BD081C">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffffff" class="bi bi-pinterest" viewBox="0 0 16 16">
            ...
            <div class="foot-icon-grid">
                <a href="https://www.facebook.com/YachtsDotCom/" target="_blank" class="social-icon" style="background-color:#3B5998">
            ...
            <div class="foot-icon-grid">    
                <a href="https://www.youtube.com/channel/UC2eUubcJuRuP4GzmFWE0Asg" target="_blank" class="social-icon" style="background-color:#CD201F">
            ...
            <div class="foot-icon-grid">
                <a href="https://www.instagram.com/yachtscom/" target="_blank" class="social-icon" style="background-color:#262626">
        ...
        <p class="text-center mt-3"><a href="https://yachts.com" target="_blank"><img src="/images/logo.png" alt="Logo"></a> </p>
    </div>
    <br>
</div>
