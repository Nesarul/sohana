    ...
    <script>
        $("title").html("Yachts.com - Privacy Policy");
        $("meta[name='description']").attr("content", "Privacy Policy");
        $("meta[name='keywords']").attr("content", "Privacy Policy");
    </script>
    <div class="container">
        <div class="row py-5">
            <div class="col-12">
                <h2 class="text-start mb-3">Privacy Policy</h2>
                ...
                <div class="card mb-3 w-100">
                    <div class="card-body">
                        ...
                        <li><strong>Company</strong>&nbsp;(referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to Yachts.com, 9450 SW Gemini Dr. #56742 Beaverton, OR 97008.</li>
                        ...
                        <li><strong>Website</strong>&nbsp;refers to Yachts.com, accessible from&nbsp;<a href="https://yachts.com/" target="_blank" rel="noreferrer noopener">https://yachts.com</a></li>
                        ...
                        <li><strong>Flash Cookies.</strong>&nbsp;Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &ldquo;Where can I change the settings for disabling, or deleting local shared objects?&rdquo; available at&nbsp;<a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" target="_blank" rel="noreferrer noopener">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a></li>
                        <li><strong>Web Beacons.</strong>&nbsp;Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
                        </ul>
                        <p>Cookies can be &ldquo;Persistent&rdquo; or &ldquo;Session&rdquo; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here:&nbsp;<a href="https://www.termsfeed.com/blog/cookies/" target="_blank" rel="noreferrer noopener">All About Cookies by TermsFeed</a>.</p>
                        ...
                        <ul>
                        <li>By email: <a href="mailto:eric@yachts.com">eric@yachts.com</a></li>
                        <li></li>
                        </ul>
                    </div>
                </div>
